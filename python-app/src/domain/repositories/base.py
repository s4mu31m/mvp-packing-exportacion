...
class ControlProcesoPackingRecord:
    ...
    velocidad_volcador: Optional[Decimal] = None
    obs_volcador: str = ""
    cloro_libre_ppm: Optional[Decimal] = None
    tiempo_inmersion_seg: Optional[int] = None
    temp_aire_secado: Optional[Decimal] = None
    velocidad_ventiladores: Optional[Decimal] = None
    fruta_sale_seca: Optional[bool] = None
    tipo_cera: str = ""
    dosis_cera_ml_min: Optional[Decimal] = None
    temp_cera: Optional[Decimal] = None
    cobertura_uniforme: Optional[bool] = None
    n_operarios_seleccion: Optional[int] = None
    fruta_dano_condicion_kg: Optional[Decimal] = None
    fruta_dano_calidad_kg: Optional[Decimal] = None
    fruta_pudricion_kg: Optional[Decimal] = None
    merma_total_seleccion_kg: Optional[Decimal] = None
    equipo_calibrador: str = ""
    calibre_predominante: str = ""
    pct_calibre_export: Optional[Decimal] = None
    pct_calibres_menores: Optional[Decimal] = None
    tipo_caja: str = ""
    peso_promedio_caja_kg: Optional[Decimal] = None
    n_cajas_producidas: Optional[int] = None
    operator_code: str = ""
    source_system: str = "local"
    rol: str = ""
