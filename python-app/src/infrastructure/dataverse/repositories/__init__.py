...
def _row_to_bin(row: dict) -> BinRecord:
    return BinRecord(
        ...
        codigo_sag_csg=_str(row.get(BIN_FIELDS["codigo_sag_csg"])),
        codigo_sag_csp=_str(row.get(BIN_FIELDS["codigo_sag_csp"])),
        codigo_sdp=_str(row.get(BIN_FIELDS["codigo_sdp"])),
        lote_productor=_str(row.get(BIN_FIELDS["lote_productor"])),
...
_BIN_SELECT = [BIN_FIELDS[k] for k in (
    ...
    "numero_cuartel", "nombre_cuartel", "codigo_sag_csg", "codigo_sag_csp",
    "codigo_sdp", "lote_productor", "sector",
    ...
    def create(
        ...
        *,
        ...
        _extra_map = {
            ...
            "codigo_sag_csg":     BIN_FIELDS["codigo_sag_csg"],
            "codigo_sag_csp":     BIN_FIELDS["codigo_sag_csp"],
            "codigo_sdp":         BIN_FIELDS["codigo_sdp"],
