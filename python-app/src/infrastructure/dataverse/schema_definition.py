...
REQUIRED_SCHEMA: list[EntitySpec] = [
    ...
    EntitySpec(
        ...
        fields=[
            ...
            _str("crf21_codigo_sag_csg", "Codigo SAG CSG", max_length=100),
            _str("crf21_codigo_sag_csp", "Codigo SAG CSP", max_length=100),
            _str("crf21_codigo_sdp", "Codigo SDP", max_length=100),
            _str("crf21_lote_productor", "Lote Campo", max_length=100),
    ...
    EntitySpec(
        ...
        fields=[
            ...
            _dec("crf21_velocidad_volcador", "Velocidad Volcador"),
            _str("crf21_obs_volcador", "Observacion Volcador", max_length=200),
            _dec("crf21_cloro_libre_ppm", "Cloro Libre PPM"),
            _int("crf21_tiempo_inmersion_seg", "Tiempo Inmersion Seg", min_val=0, max_val=9999),
            _dec("crf21_temp_aire_secado", "Temperatura Aire Secado"),
            _dec("crf21_velocidad_ventiladores", "Velocidad Ventiladores"),
            _bool("crf21_fruta_sale_seca", "Fruta Sale Seca"),
            _str("crf21_tipo_cera", "Tipo Cera", max_length=50),
            _dec("crf21_dosis_cera_ml_min", "Dosis Cera ML Min"),
            _dec("crf21_temp_cera", "Temperatura Cera"),
            _bool("crf21_cobertura_uniforme", "Cobertura Uniforme"),
            _int("crf21_n_operarios_seleccion", "N Operarios Seleccion", min_val=0, max_val=999),
            _dec("crf21_fruta_dano_condicion_kg", "Fruta Dano Condicion Kg"),
            _dec("crf21_fruta_dano_calidad_kg", "Fruta Dano Calidad Kg"),
            _dec("crf21_fruta_pudricion_kg", "Fruta Pudricion Kg"),
            _dec("crf21_merma_total_seleccion_kg", "Merma Total Seleccion Kg"),
            _str("crf21_equipo_calibrador", "Equipo Calibrador", max_length=50),
            _str("crf21_calibre_predominante", "Calibre Predominante", max_length=20),
            _dec("crf21_pct_calibre_export", "Pct Calibre Export", min_val=0, max_val=100),
            _dec("crf21_pct_calibres_menores", "Pct Calibres Menores", min_val=0, max_val=100),
            _str("crf21_tipo_caja", "Tipo Caja", max_length=50),
            _dec("crf21_peso_promedio_caja_kg", "Peso Promedio Caja Kg"),
            _int("crf21_n_cajas_producidas", "N Cajas Producidas", min_val=0, max_val=999999),
            *_common_control_fields(),
        ],
    ),
