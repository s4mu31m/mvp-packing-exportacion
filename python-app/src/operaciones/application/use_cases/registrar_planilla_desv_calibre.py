...
def registrar_planilla_desv_calibre(
    payload: dict, *, repos: Repositories | None = None
) -> UseCaseResult:
    """
    Persiste una planilla de calibres desverdizado via repositorio.
    ...
    record = repos.planillas_desv_calibres.create(
        lote_id,
    ...
    return UseCaseResult.success(
        code="PLANILLA_DESV_CALIBRE_REGISTRADA",
        message="Planilla de calibres desverdizado registrada",
        data={"id": record.id},
    )
